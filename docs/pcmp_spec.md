...
Version 1 Specification (Draft, Frozen Semantics)
...
# 10. Deterministic Computation Boundary Conditions **[Normative]**

## 10.1 Zero-Entropy Fixed Point Theorem **[Normative]**

Let **P** be a producer that emits a finite ordered sequence **S** of IEEE-754 binary32 values.

Assume:
- **P** is deterministic  
- **P** is race-free and side-effect-free  
- **P** introduces no external entropy  

Let **C** be the PCMP canonicalization, permutation, and predictive transform defined in this specification.

Then:

**C(S)** is a fixed point under replay, permutation, and verification.

## 10.2 Corollary — Impossibility of Adversarial Unscrambling **[Normative]**

Under the above conditions, no procedure operating solely on PCMP-encoded artifacts can distinguish between repeated executions of **P**.

## 10.3 Practical Implication **[Normative]**

PCMP exists solely to make the producer’s commitment irreversible and verifiable.
...
# 12. Failure Semantics (Fail-Closed) **[Normative]**
...
# 13. Test Vectors **[Recommended]**

The specification **SHOULD** include canonical float sequences and expected hashes.

---

# 14. Threat Model **[Recommended]**

The system assumes hostile inputs and defends against reordering attacks.
